...
import 'package:leaderboard/page_list.dart';
import 'package:leaderboard/second_movie_page.dart';
              ...
              Container(
                ...
                child: PageView.builder(
                    ...
                    onPageChanged: (currentIndex) {
                      setState(() {
                        _currentIndex = currentIndex as double;
                      });
                    },
                    itemBuilder: (BuildContext context, int index) {
                      double marginY =
                          (_currentIndex - index).abs().toDouble() * 50.0;
                      return InkWell(
                        onTap: () {
                          setState(() {
                            Navigator.push(
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image:
                                            NetworkImage(pageList[idx].image),
                                        fit: BoxFit.fill)),
                              ),
                            ),
                          ],
